...
summary: The repository has a validated Constitution, governance-first Orchestrator, 22-Standard-Skill registry, 12-workflow registry, governed VOPL procedural memory, separate 27-module Custom Skill library, approval gates, routing fixtures, and executable lint.
status: verified
confidence: high
...
evidence: [22 Standard Skills and 12 workflows pass their linters, Habit lint passes a default-deny registry plus valid/adversarial fixtures, 27 reusable Custom Skills pass quick validation and custom lint, stack/domain manifests match repository evidence, 24 Standard and 12 Custom routing fixtures pass]
...
supersedes: []
superseded_by:
related_memories: [MEM-PROJECT-0001, MEM-CONSTRAINT-0001, MEM-GAP-0001, MEM-TEMPLATE-STANDARD-0001, MEM-CUSTOM-SKILL-SYSTEM-0001, DEC-0002, TASK-20260716-project-engineering-skill-system, TASK-20260716-template-production-standard, TASK-20260716-reusable-custom-skill-system, TASK-20260723-acr-procedural-memory-hardening]
...
The project-local instruction architecture integrates Constitution, governance-first Orchestration, 22 Standard Skills, 12 Workflows, governed VOPL procedural memory, a separate 27-module Custom Skill library, Project Memory, and repository onboarding/governance. The Orchestrator selects one primary workflow and minimum Standard Skills, verifies memory and approvals, then may consider a verified bounded habit as an execution optimization.

## Evidence

- `PROJECT-CONSTITUTION.md` defines authority, risk, pre/post gates, exceptions, context, and controlled self-update.
- `SKILL-REGISTRY.json` contains 22 active skills with paths, dependencies, risk usage, task classes, and workflow use.
...
- The unified suite validates repository hygiene, Standard Skills, workflows, the default-deny habit registry and adversarial VOPL fixtures, Custom Skills, stack/domain synchronization, 24 Standard routing fixtures, 12 Custom routing fixtures, routes/links, anti-patterns, and Project Memory.
