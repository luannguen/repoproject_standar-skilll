...
supersedes: []
superseded_by:
related_memories: [MEM-GAP-0001, MEM-QUESTION-0001, MEM-UI-0001, MEM-BACKEND-0001, MEM-SKILL-SYSTEM-0001, MEM-TEMPLATE-STANDARD-0001, MEM-CUSTOM-SKILL-SYSTEM-0001, DEC-0002, TASK-20260716-template-production-standard, TASK-20260716-reusable-custom-skill-system, TASK-20260723-acr-procedural-memory-hardening]
---
...
- The repository is under Git with a configured GitHub remote; the active working branch is task-specific evidence, not a durable project invariant.
- It contains a validated Project Engineering Skill System: Constitution, governance-first Orchestrator, Approval Gates, 22 registered Standard Skills, 12 registered workflows, 24 Standard routing fixtures, and unified executable validation.
...
- It also contains a default-deny governed VOPL procedural-memory registry, deterministic valid/adversarial habit fixtures, and a reusable onboarding, governance, contribution, security, release, ownership, and cross-platform CI baseline.
...
- Skill lint verifies 22 skills, workflow lint verifies 12 workflows, and habit lint verifies the empty default-deny registry plus valid/adversarial fixtures.
...
- Repository, habit, route/link, anti-pattern, and memory validation pass locally.
